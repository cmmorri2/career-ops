import { LayoutDashboard, Compass, ListChecks, Radar, SearchCheck, BarChart3, FileText, Settings } from "lucide-react";
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/role-discovery", label: "Role Discovery", icon: SearchCheck, chip: "New" },
