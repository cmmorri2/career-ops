...
See [docs/SETUP.md](docs/SETUP.md) for the full setup guide, [docs/WORKFLOW.md](docs/WORKFLOW.md) for a plain-English map of the end-to-end job-search flow, [docs/RUNNING_ON_A_BUDGET.md](docs/RUNNING_ON_A_BUDGET.md) for instructions on running career-ops cheaply using custom or local models, and [docs/FAQ.md](docs/FAQ.md) for answers to common setup questions.
